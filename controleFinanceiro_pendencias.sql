...
CREATE TABLE `pendencias` (
  ...
  `importancia` set('0','1','2') DEFAULT NULL,
  `dataRealizar` date DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_pendencias_usuario` (`usuario`),
  CONSTRAINT `fk_pendencias_usuario` FOREIGN KEY (`usuario`) REFERENCES `usuarios` (`id`)
